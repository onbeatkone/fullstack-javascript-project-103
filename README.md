...
[![hexlet-check](https://github.com/onbeatkone/fullstack-javascript-project-103/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/onbeatkone/fullstack-javascript-project-103/actions)
...
```bash
git clone https://github.com/onbeatkone/fullstack-javascript-project-103.git
